"""Scraper for Dhalia Real Estate (dhalia.com)."""
...
class DhaliaScraper(ListingPageScraper):
    """Scraper for Dhalia Real Estate Malta."""

    BASE_URL = "https://www.dhalia.com"

    # Property type mapping for Dhalia
    PROPERTY_TYPE_MAP = {
    ...
    def _build_search_url(
        ...
        """Build search URL for Dhalia."""
        listing_type = "rent" if is_rental else "sale"
        url = f"{self.base_url}/properties/{listing_type}/"
    ...
    def _get_listing_containers(self, parser: HTMLParser) -> List[Tag]:
        """Get property listing containers from Dhalia page."""
        selectors = [
            ".property-card",
            ".property-item",
            ".listing-item",
    ...
    def _parse_listing_element(self, element: Tag, base_url: str) -> Optional[Property]:
        """Parse a single Dhalia listing element into Property."""
        try:
    ...
    async def get_property(self, url: str) -> Optional[Property]:
        """Get detailed property information from Dhalia."""
        try:
